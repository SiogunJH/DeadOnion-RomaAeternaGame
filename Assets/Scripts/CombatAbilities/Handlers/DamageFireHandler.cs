...
public class DamageFireHandler : ICombatAbilityEffectHandler
{
    public static CombatAbilityEffect.EffectType EffectType => CombatAbilityEffect.EffectType.DamageFire;
