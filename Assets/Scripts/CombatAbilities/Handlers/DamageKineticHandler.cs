...
public class DamageKineticHandler : ICombatAbilityEffectHandler
{
    public static CombatAbilityEffect.EffectType EffectType => CombatAbilityEffect.EffectType.DamageKinetic;
