...
public class DamageEnergyHandler : ICombatAbilityEffectHandler
{
    public static CombatAbilityEffect.EffectType EffectType => CombatAbilityEffect.EffectType.DamageEnergy;
